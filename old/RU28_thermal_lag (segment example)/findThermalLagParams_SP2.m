...
%             ((pres2(min_idx2:max_idx2)-thermocline_pres2)-pressure_min)/(pressure_max-pressure_min));
    ...
    % area in original salinity-pressure space
    area = ...
      profileArea(salt_cor1(min_idx1:max_idx1), pres1(min_idx1:max_idx1)-thermocline_pres1, ...
                  salt_cor2(min_idx2:max_idx2), pres2(min_idx2:max_idx2)-thermocline_pres2);
