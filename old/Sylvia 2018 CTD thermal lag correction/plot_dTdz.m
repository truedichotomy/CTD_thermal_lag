...
hold off
legend('down cast', 'upcast', 'location','southwest')
grid on
...
plot(segment_down(iter).dTdz, segment_down(iter).z_lag_shifted(2:end), 'r-*')
hold on
plot(segment_up(iter).dTdz, segment_up(iter).z_lag_shifted(2:end),'b-sq')
