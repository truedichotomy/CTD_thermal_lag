...
for iter = 1:segment_n_pair    
    ...
    segment_profile_pair(iter).ThermalLagParams = ...
        findThermalLagParams_TS_haixing(segment_down(iter).time, ...
...
%     iter
    ...
    segment_down(iter).salt_inside = ...
        ...
        segment_down(iter).pressure_lag_shifted); % salinity, pressure in dbar and conductivity from S/m to mS/cm.
    
    segment_down(iter).saltA_inside = ...
        gsw_SA_from_SP(segment_down(iter).salt_inside, ...
        segment_down(iter).pressure_lag_shifted, ...
        segment_down(iter).longitude,segment_down(iter).latitude); % absolute salinity, pressure in dbar
    
    segment_down(iter).ctemp_inside = ...
        gsw_CT_from_t(segment_down(iter).saltA_inside, ...
        segment_down(iter).temp_inside, ...
        segment_down(iter).pressure_lag_shifted); % conservative temperature, pressure in dbar
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       ...
       segment_up(iter).salt_inside = ...
        ...
        segment_up(iter).pressure_lag_shifted); % salinity, pressure in dbar and conductivity from S/m to mS/cm.
    
    segment_up(iter).saltA_inside = ...
        gsw_SA_from_SP(segment_up(iter).salt_inside, ...
        segment_up(iter).pressure_lag_shifted, ...
        segment_up(iter).longitude,segment_up(iter).latitude); % absolute salinity, pressure in dbar
    
    segment_up(iter).ctemp_inside = ...
        gsw_CT_from_t(segment_up(iter).saltA_inside, ...
        segment_up(iter).temp_inside, ...
        segment_up(iter).pressure_lag_shifted); % conservative temperature, pressure in dbar
...
%     iter
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    toc
%%
save Sylvia_May2018_segment_data.mat
