...
sci_data.date_num = datenum(1970, 1, 1, 0, 0, sci_data.sci_ctd41cp_timestamp);
...
% segment_data = IndexedStructCopy(sci_data, sci_data.ctd_time>=segment_t1 & sci_data.ctd_time<=segment_t2);
